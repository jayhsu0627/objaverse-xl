...
class GitHubDownloader(ObjaverseSource):
    ...
    @classmethod
    def get_annotations(
        cls, download_dir: str = "/home/sjxu/Documents/objaverse-xl/.objaverse", refresh: bool = False
    ) -> pd.DataFrame:
    ...
    def download_objects(
        ...
        download_dir: Optional[str] = "/home/sjxu/Documents/objaverse-xl/.objaverse",
